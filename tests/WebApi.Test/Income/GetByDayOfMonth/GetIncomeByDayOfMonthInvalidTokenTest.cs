...
public class GetIncomeByDayOfMonthInvalidTokenTest : MobileFinanceClassFixture
{
    private const string ROUTE = "income/filter-by-day";

    public GetIncomeByDayOfMonthInvalidTokenTest(MobileFinanceWebApplicationFactory factory) : base(factory) { }
