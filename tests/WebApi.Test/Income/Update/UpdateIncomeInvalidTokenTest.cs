...
public class UpdateIncomeInvalidTokenTest : MobileFinanceClassFixture
{
    private const string ROUTE = "income";

    public UpdateIncomeInvalidTokenTest(MobileFinanceWebApplicationFactory factory) : base(factory) { }
    ...
    public async Task Error_Invalid_Token(string culture)
    {
        ...
        var response = await DoPut(route: $"{ROUTE}/{id}", request: request, token: "tokenInvalid", culture: culture);
    ...
    public async Task Error_Empty_Token(string culture)
    {
        ...
        var response = await DoPut(route: $"{ROUTE}/{id}", request: request, token: string.Empty, culture: culture);
