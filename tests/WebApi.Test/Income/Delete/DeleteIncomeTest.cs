...
public class DeleteIncomeTest : MobileFinanceClassFixture
{
    private const string ROUTE = "income";
    private readonly Guid _userIdentifier;
    private readonly string _incomeId;

    public DeleteIncomeTest(MobileFinanceWebApplicationFactory factory) : base(factory)
    {
    ...
    public async Task Success()
    {
        ...
        var response = await DoDelete(route: $"{ROUTE}/{_incomeId}", token: token);
