...
public class ChangeUserPasswordInvalidTokenTest : MobileFinanceClassFixture
{
    private const string ROUTE = "user/change-password";

    public ChangeUserPasswordInvalidTokenTest(MobileFinanceWebApplicationFactory factory) : base(factory) { }
