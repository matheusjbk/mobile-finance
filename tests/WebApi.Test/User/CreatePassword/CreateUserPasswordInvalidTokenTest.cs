...
public class CreateUserPasswordInvalidTokenTest : MobileFinanceClassFixture
{
    private const string ROUTE = "user/create-password";

    public CreateUserPasswordInvalidTokenTest(MobileFinanceWebApplicationFactory factory) : base(factory) { }
    ...
    public async Task Error_Invalid_Token(string culture)
    {
        ...
        var response = await DoPost(route: ROUTE, request: request, token: "invalidToken", culture: culture);
