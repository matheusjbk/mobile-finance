...
public class GetDebitByIdInvalidTokenTest : MobileFinanceClassFixture
{
    private const string ROUTE = "debit";

    public GetDebitByIdInvalidTokenTest(MobileFinanceWebApplicationFactory factory) : base(factory) { }
