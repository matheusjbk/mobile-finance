...
public class DeleteDebitTest : MobileFinanceClassFixture
{
    private const string ROUTE = "debit";
    private readonly Guid _userIdentifier;
    private readonly string _debitId;

    public DeleteDebitTest(MobileFinanceWebApplicationFactory factory) : base(factory)
    {
    ...
    public async Task Success()
    {
        ...
        var response = await DoDelete(route: $"{ROUTE}/{_debitId}", token: token);
