...
namespace WebApi.Test.Debit.Delete;
public class DeleteDebitInvalidTokenTest : MobileFinanceClassFixture
{
    private const string ROUTE = "debit";

    public DeleteDebitInvalidTokenTest(MobileFinanceWebApplicationFactory factory) : base(factory) { }
