...
public class GetDebitByDayOfMonthInvalidTokenTest : MobileFinanceClassFixture
{
    private const string ROUTE = "debit/filter-by-day";

    public GetDebitByDayOfMonthInvalidTokenTest(MobileFinanceWebApplicationFactory factory) : base(factory) { }
