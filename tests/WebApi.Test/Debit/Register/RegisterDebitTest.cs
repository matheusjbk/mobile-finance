...
namespace WebApi.Test.Debit.Register;
public class RegisterDebitTest : MobileFinanceClassFixture
{
    private const string ROUTE = "debit";
    private readonly Guid _userIdentifier;

    public RegisterDebitTest(MobileFinanceWebApplicationFactory factory) : base(factory) => _userIdentifier = factory.GetUserIdentifier();
