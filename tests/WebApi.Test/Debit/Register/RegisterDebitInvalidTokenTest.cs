...
public class RegisterDebitInvalidTokenTest : MobileFinanceClassFixture
{
    private const string ROUTE = "debit";

    public RegisterDebitInvalidTokenTest(MobileFinanceWebApplicationFactory factory) : base(factory) { }
