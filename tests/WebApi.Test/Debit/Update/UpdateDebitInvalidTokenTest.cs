...
public class UpdateDebitInvalidTokenTest : MobileFinanceClassFixture
{
    private const string ROUTE = "debit";

    public UpdateDebitInvalidTokenTest(MobileFinanceWebApplicationFactory factory) : base(factory) { }
